...
def w(cosmo_params, a):
    ...
    .. math::
        ...
        w(a) = w_0 + w_a (1 - a)
    """
    return cosmo_params['w0'] + (1.0 - a) * cosmo_params['wa']  # Equation (6) in Linder (2003)


def f_de(cosmo_params, a):
    ...
    """
    return -3.0 * (1.0 + cosmo_params['w0'] + cosmo_params['wa']) * np.log(a) + 3.0 * cosmo_params['wa'] * (a - 1.0)
...
def Esqr(cosmo, a):
    ...
    """
    return (
        cosmo_params['Om0'] * np.power(a, -3)
        + cosmo_params['Ok0'] * np.power(a, -2)
        + cosmo_params['Ode0'] * np.exp(f_de(cosmo, a))
    )
...
def H(cosmo, a):
    ...
    """
    return cosmo_params['H0'] * np.sqrt(Esqr(cosmo, a))
...
def Omega_m_a(cosmo, a):
    ...
    """
    return cosmo_params['Om0'] * np.power(a, -3) / Esqr(cosmo, a)
...
def Omega_de_a(cosmo, a):
    ...
    """
    return cosmo_params['Ode0'] * np.exp(f_de(cosmo, a)) / Esqr(cosmo, a)
